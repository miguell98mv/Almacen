...
const inputMascota = document.querySelector("#tipo-mascota1"); //Convertimos a la const imputMascota
...
inputMascota.addEventListener("input", function(){//Esta funcion se va a ejecutar cadavez que escribimos
  ...
  //conexion a BD
  httpRequest("controller.php?resultado=" + tipoMascota, function(){//llamamos la funcion
