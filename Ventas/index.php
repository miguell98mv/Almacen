...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title></title>
    <link rel="stylesheet" type="text/css" href="ventas6.css">
      <link rel="stylesheet" type="text/css" href="tabla13.css">
  ...
  <body>
    ...
    <header>
      <form class="" id="boton_mini" action="../Busqueda" autocomplete="off" method="GET">
      <div class="menu_bar">
        ...
        <nav>
           <ul>
             <li><a id="bt-munu1" href="../"><i style="margin-right: 10px;" class="fas fa-home"></i>Inicio</a></li>
              ...
              <li><a href=""><i class="far fa-money-bill-alt"></i>Ventas</a></li>
